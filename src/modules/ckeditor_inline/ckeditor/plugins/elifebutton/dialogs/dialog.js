CKEDITOR.dialog.add('elifeButtonDialog', function(editor) {
  return {
    ...
    contents: [
      {
        ...
        elements: [
          ...
          },
          {
            ...
            setup: function(element) {
              this.setValue(element.hasClass("elife-button--outline"));
            }           
          }
        ]
      }
    ...
    onOk: function() {
      ...
      if (dialog.getValueOf('options', 'outline')) {
        button.removeClass('elife-button--default');
        button.addClass('elife-button--outline');
      }
      else {
        button.removeClass('elife-button--outline');
